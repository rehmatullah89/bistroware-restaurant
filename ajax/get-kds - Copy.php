...
/*                            if($Difference < 60)
                        ...
                        ?>
                        <li id="LiId<?=$i?>" style="border: 3px solid white;" class="clearfix <?=($i%2==0?'alt':'')?> <?=(($sUpdated == 'Y' && $iOrderStatus != 0)?'quadrat':'')?>">
				<section class="left">
				...
				<section class="right">
					...
					<table border="0" cellspacing="1" cellpadding="3" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?
                                                $sOldCategory = "";
                                                $sSQL2 = "Select * from tbl_order_details where order_id='$iOrder' ORDER By category_name";
                                                $objDb2->query($sSQL2);
...
<? 
                                                        ...
                                                        {
?>
                                                    <span style="display: block;" id="<?=$i."_".$j?>" src="<?=($sStatus == 'C'?'green':'red')?>" onclick='ToggleItemStatus(this.id,"<?=$iDetailId?>","<?=$iOrder?>")'><?=$iQuantity." X ".$sItem.($sRemarks != ""?"<br/><div style='font-size:10px; background-color:yellow; color: black;'>".substr($sRemarks , 0, 32)."<br />".substr($sRemarks , 32)."</div>":"")?></span>
<?
                                                        }else{
?>
...
?>
                                                ...
                                                <td id="Td2<?=$i."_".$j?>" style="font-size:10px; <?=($sStatus == 'C'?'background-color:#007E1C;':'background-color:#7E1B00;')?>">
<?
                                                    //($sItemCookingTime[$iProductId] != "")?$sItemCookingTime[$iProductId].":00":"0";
                                                    if($sStatus == 'P' || $sStatus == 'V')
                                                    {
                                                        echo "0";
                                                    }
                                                    else if($sStatus == 'R' || $sStatus == 'A')
                                                    {
                                                        echo $Difference.":00";
                                                    }
                                                    else if($sStatus == 'C')
...
?>
    ...
    function ToggleItemStatus(ImgId, ItemId, OrderId)
    {
