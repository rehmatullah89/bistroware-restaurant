...
$(document).ready(function( )
{
	...
	$(document).on("click", "#DataGrid .icnEdit", function(event)
	{
		...
		$.colorbox({ href:("administration/edit-email.php?EmailId=" + iEmailId + "&Index=" + iIndex), width:"90%", height:"95%", iframe:true, opacity:"0.50", overlayClose:false });
	...
	$(document).on("click", "#DataGrid .icnView", function(event)
	{
		...
		$.colorbox({ href:("administration/view-email.php?EmailId=" + iEmailId), width:"70%", height:"75%", iframe:true, opacity:"0.50", overlayClose:true });
	...
	$(document).on("click", ".icnToggle", function(event)
	{
		...
		$.post("ajax/administration/toggle-email-status.php",
			{ EmailId:objIcon.id },
	...
	$(document).on("click", ".icnReset", function(event)
	{
		...
		$("#ConfirmReset").dialog( { resizable : false,
		                              ...
		                              buttons   : { "Reset" : function( )
		                                                       {
										$.post("ajax/administration/reset-email.php",
											{ EmailId:iEmailId },
