...
$(document).ready(function( )
{
	...
	if (parseInt($("#TotalRecords").val( )) > 50)
	{
		objTable = $("#DataGrid").dataTable( { sDom            : '<"H"f<"toolbar"><"TableTools">>t<"F"ip>',
											   ...
											   bAutoWidth      : false,
											   bServerSide     : true,
											   sAjaxSource     : "ajax/inventory/get-ingredients.php",
											 ...
											 fnDrawCallback  : function( )
											   ...
											   fnInitComplete  : function( )
																 {
																	$.post("ajax/inventory/get-ingredient-filters.php",
																		   {},
		...
		if (sIngredients != "")
		{
			$("#ConfirmMultiDelete").dialog( { resizable : false,
											   ...
											   buttons   : { "Delete" : function( )
															{
															 $.post("ajax/inventory/delete-ingredient.php",
	...
	$(document).on("click", ".icnEdit", function(event)
	{
		...
		$.colorbox({ href:("inventory/edit-ingredient.php?IngredientId=" + iLocationId + "&Index=" + iIndex), width:"40%", height:"70%", iframe:true, opacity:"0.50", overlayClose:false });
	...
	$(document).on("click", ".icnView", function(event)
	{
		...
		$.colorbox({ href:("inventory/view-ingredient.php?IngredientId=" + iLocationId), width:"40%", height:"70%", iframe:true, opacity:"0.50", overlayClose:true });
