...
$(document).ready(function( )
{
		...
		if (sReasons != "")
		{
			$("#ConfirmMultiDelete").dialog( { resizable : false,
							   ...
							   buttons   : { "Delete" : function( )
										    {
											     $.post("ajax/management/delete-reason.php",
												    { Reasons:sReasons },
	...
	$(document).on("click", "#DataGrid .icnEdit", function(event)
	{
		...
		$.colorbox({ href:("management/edit-reason.php?ReasonId=" + iReasonId + "&Index=" + iIndex), width:"400px", height:"300px", iframe:true, opacity:"0.50", overlayClose:false });
	...
	$(document).on("click", "#DataGrid .icnToggle", function(event)
	{
		...
		$.post("ajax/management/toggle-reason-status.php",
			{ ReasonId:objIcon.id },
	...
	$("#frmRecord #txtReason").blur(function( )
	{
		...
		$.post("ajax/management/check-reason.php",
