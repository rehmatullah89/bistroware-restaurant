...
$(document).ready(function( )
{
	...
	$("#frmRecord").submit(function( )
	{
		...
		if (!objFV.validate("txtLocation", "B", "Please enter the Location."))
			return false;
                ...
                if (!objFV.validate("ddFloor", "B", "Please select a Floor."))
			return false; 
	...
	if (parseInt($("#TotalRecords").val( )) > 50)
	{
		objTable = $("#DataGrid").dataTable( { sDom            : '<"H"f<"toolbar"><"TableTools">>t<"F"ip>',
											   ...
											   bAutoWidth      : false,
											   bServerSide     : true,
											   sAjaxSource     : "ajax/management/get-audit-locations.php",
											 ...
											 fnDrawCallback  : function( )
											   ...
											   fnInitComplete  : function( )
																 {
																	$.post("ajax/management/get-audit-location-filters.php",
																		   {},
		...
		if (sLocations != "")
		{
			$("#ConfirmMultiDelete").dialog( { resizable : false,
											   ...
											   buttons   : { "Delete" : function( )
															{
															 $.post("ajax/management/delete-audit-location.php",
	...
	$(document).on("click", ".icnEdit", function(event)
	{
		...
		$.colorbox({ href:("management/edit-audit-location.php?LocationId=" + iLocationId + "&Index=" + iIndex), width:"350px", height:"350px", iframe:true, opacity:"0.50", overlayClose:false });
	...
	$(document).on("click", ".icnView", function(event)
	{
		...
		$.colorbox({ href:("management/view-audit-location.php?LocationId=" + iLocationId), width:"350px", height:"350px", iframe:true, opacity:"0.50", overlayClose:true });
