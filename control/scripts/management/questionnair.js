...
$(document).ready(function( )
{
	...
	if (parseInt($("#TotalRecords").val( )) > 50)
	{
		objTable = $("#DataGrid").dataTable( { sDom            : '<"H"f<"toolbar"><"TableTools">>t<"F"ip>',
											   ...
											   bAutoWidth      : false,
											   bServerSide     : true,
											   sAjaxSource     : "ajax/management/get-questionnaire.php",
											 ...
											 fnDrawCallback  : function( )
											   ...
											   fnInitComplete  : function( )
																 {
																	$.post("ajax/management/get-questionnaire-filters.php",
																		   {},
		...
		if (sQuestions != "")
		{
			$("#ConfirmMultiDelete").dialog( { resizable : false,
											   ...
											   buttons   : { "Delete" : function( )
															{
															 $.post("ajax/management/delete-questionnaire.php",
	...
	$(document).on("click", ".icnEdit", function(event)
	{
		...
		$.colorbox({ href:("management/edit-questionnaire.php?QuestionId=" + iQuestionId + "&Index=" + iIndex), width:"350px", height:"350px", iframe:true, opacity:"0.50", overlayClose:false });
	...
	$(document).on("click", ".icnView", function(event)
	{
		...
		$.colorbox({ href:("management/view-questionnaire.php?QuestionId=" + iQuestionId), width:"350px", height:"350px", iframe:true, opacity:"0.50", overlayClose:true });
