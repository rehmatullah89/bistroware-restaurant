	    ...
	    <div id="tabs-1">
	      ...
	      <div id="ConfirmUserMultiDelete" title="Delete Users?" class="dlgConfirm hidden">
	        ...
	        Are you sure, you want to Delete the selected Users?<br />
               ...
               <div align="right"><button id="BtnExport" rel="<?= (SITE_URL.ADMIN_CP_DIR) ?>/<?= $sCurDir ?>/export-users.php">Export Users</button></div>
	      <br />
...
?>
				  ...
				  <div>
				    <input type="checkbox" name="ddSendSms" id="ddSendSms" value="Y" <?= ((IO::strValue('ddSendSms') == "Y") ? "checked" : "") ?> />
				  </div>
				  ...
				  <div>
				    <input type="checkbox" name="ddVoidSms" id="ddVoidSms" value="Y" <?= ((IO::strValue('ddVoidSms') == "Y") ? "checked" : "") ?> />
				  </div>
				  ...
				  <div>
				    <input type="checkbox" name="ddSalesSms" id="ddSalesSms" value="Y" <?= ((IO::strValue('ddSalesSms') == "Y") ? "checked" : "") ?> />
				  </div>
