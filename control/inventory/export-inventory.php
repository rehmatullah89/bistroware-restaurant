	...
	***********************************************************************************************
	...
	$objDb2      = new Database( );
        ...
        if($sStartDate == $sEndDate && $sStartDate == date("Y-m-d"))
            ...
            $sDate = date('Y-m-d', strtotime($sStartDate))." - ". date('Y-m-d', strtotime($sEndDate));
	...
	/////////////////////////////////////////////////////////////////////
        ...
        $objPhpExcel->getActiveSheet()->setCellValue("A4", "Report Date: ".$sDate);
		...
		$objPhpExcel->getActiveSheet()->setCellValue("E{$iRow}", $sOrigin);               
                ...
                $objPhpExcel->getActiveSheet()->setCellValue("O{$iRow}", $sLotDate);               
                $objPhpExcel->getActiveSheet()->setCellValue("P{$iRow}", $sManufacDate); 
                $objPhpExcel->getActiveSheet()->setCellValue("Q{$iRow}", $sExpiryDate); 
                

        	if($sItemType == 'I')
                    $objPhpExcel->getActiveSheet()->duplicateStyleArray($sImportedStyle, "A{$iRow}:Q{$iRow}");  
                else
                    $objPhpExcel->getActiveSheet()->duplicateStyleArray($sLocalStyle, "A{$iRow}:Q{$iRow}");    
        ...
        $objPhpExcel->getActiveSheet()->duplicateStyleArray($sHeadingStyle, "A{$iRow}:Q{$iRow}");
        ...
        $objPhpExcel->getActiveSheet()->duplicateStyleArray($sSubHeadingStyle, "A{$iRow}:Q{$iRow}");  
        ...
        $objPhpExcel->getActiveSheet()->setCellValue("O{$iRow}", "Lot DateTime"); 
        $objPhpExcel->getActiveSheet()->setCellValue("P{$iRow}", "Manufacture"); 
        $objPhpExcel->getActiveSheet()->setCellValue("Q{$iRow}", "Expiry");                
