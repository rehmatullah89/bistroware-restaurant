			  ...
			  <tr valign="top">
				<td width="205">
				  ...
				  <label for="txtRemarks">Remarks</label>
                                  <div><textarea name="txtRemarks" id="txtRemarks" rows="7" cols="20"><?=IO::strValue('txtRemarks')?></textarea></div>
                                  <div class="br10"></div>
                                  <br />
...
?>
                                          ...
                                          <td id="itemType">
                                              <select name="ddItemType[]" style="width:80px;" required>
                                          ...
                                          <td id="itemLocation">
                                              <select name="ddItemLocation[]" style="width:90px;" required>
                                           <option value=""></option>
<?
...
<?
                                          ...
                                          <td id="itemSupplier">
                                              <select name="ddItemSupplier[]" style="width:80px;" required>
                                           <option value=""></option>
<?
...
<?
                                         ...
                                         <td id="itemOrigin">
                                            <select name="ddCountry[]" style="width:80px;" required>
                                                  <option value=""></option>
<?
...
?>
                                          ...
                                          <td id="ManufacDateId">
                                              <div class="date" style="display:inline-block;"><input type="text" name="txtManufac[]" id="txtManufac1"  class="textbox" value="" maxlength="10" size="10" style='width:63%; display: inline;' readonly /></div>
                                          </td>
