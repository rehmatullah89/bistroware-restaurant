...
?>
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/locations.js"></script>
</head>
...
?>
      ...
      <div id="PageTabs">
	    <ul>
	      <li><a href="<?= $_SERVER['REQUEST_URI'] ?>#tabs-1"><b>Locations</b></a></li>
<?
	if ($sUserRights["Add"] == "Y")
	{
?>
	      <li><a href="<?= $_SERVER['REQUEST_URI'] ?>#tabs-2">Add New Location</a></li>
<?
	}
...
?>
	    ...
	    <div id="tabs-1">
	      ...
	      <div id="ConfirmDelete" title="Delete Inspection?" class="hidden dlgConfirm">
	        ...
	        Are you sure, you want to Delete this Location Record?<br />
	      </div>

	      <div id="ConfirmMultiDelete" title="Delete Products?" class="hidden dlgConfirm">
	        <span class="ui-icon ui-icon-trash"></span>
	        Are you sure, you want to Delete the selected Locations Records?<br />
	      </div>
		  ...
		  <div class="dataGrid ex_highlight_row">
		    <input type="hidden" id="TotalRecords" value="<?= $iTotalRecords = getDbValue('COUNT(1)', 'tbl_locations', "status='A'") ?>" />
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
			  <tr valign="top">
				<td width="600">
				  ...
				  <div><input type="text" name="txtLocation" id="txtLocation" value="<?= IO::strValue("txtLocation") ?>" size="20" class="textbox" /></div>
												  
				  <div class="br10"></div>

				  <label for="txtCode">Code</label>
				  <div><input type="text" name="txtCode" id="txtCode" value="<?= IO::strValue('txtCode') ?>" maxlength="20" size="8" maxlength="5" class="textbox" /></div>
                                  <div class="br10"></div>
