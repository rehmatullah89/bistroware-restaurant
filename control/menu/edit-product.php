<?
	...
	***********************************************************************************************
	...
	$iCategoryId = $objDb->getField(0, "category_id");
        $iMealId     = $objDb->getField(0, "meal_id");
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
	  <tr valign="top">
		<td width="600">
                    ...
                    <div><input type="text" name="txtProduct" id="txtProduct" value="<?= $sProduct ?>" size="20" class="textbox" /></div>
...
<?
		...
		{
?> 
                                          <option value="<?= $iMeal ?>"<?= ((@in_array($iMeal, explode(",", $iMealId))) ? ' selected' : '') ?>><?= $sMeal ?></option>
<?
		}
?>
				    </select>
...
?>
				  ...
				  <div><input type="text" name="txtCost" id="txtCost" value="<?= $iCost ?>" maxlength="20" size="8" class="textbox" /></div>
