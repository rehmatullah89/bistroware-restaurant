	...
	if ($_SESSION["Flag"] != "")
	{
		$sMessages = array(
							...
							'DOCUMENT_EXISTS'                 => 'A Document with same School & Type already exists. Please specify another Document Type or School Code.',   
                                                        ...
                                                        'MEAL_EXISTS'                 => 'The specified Meal already exists. Please specify another Meal Type.',
                                                        'MEAL_ADDED'                  => 'The specified Meal has been Added into the System successfully.',
