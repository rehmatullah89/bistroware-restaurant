...
?>
				  ...
				  <div class="br10"></div>
                                  ...
                                  <label for="txtPhone"><span>Phone <span class="required">*</span></span><input type="text" name="txtPhone" id="txtPhone" value="<?= IO::strValue("txtPhone") ?>" size="20" maxlength="11" minlength="11" class="textbox" /></label>
