...
?>
		          ...
		          <td><?= $sCreatedAt ?></td>
                          ...
                          <td><?= formatNumber($iPaidAmt, false) ?></td>
                          <td><?= $sStatus ?></td>
		          <td>
...
<?
                        ...
                        {
?>
                            <img class="icnToggle" id="<?= $iId ?>" res="<?=$sStatus?>" void="<?=$iVoids?>" src="images/icons/<?=strtolower($sStatus)?>.png" alt="Toggle Status" title="Toggle Status" />
<?
                        }
...
?>
                                  ...
                                  <div>
                                      <div class="date" style="display:inline;"><input type="text" name="txtOrderDate" id="txtOrderDate" value="<?= date("Y-m-d") ?>" maxlength="10" size="10" class="textbox" readonly /></div>
...
<?
                            ...
                            {
?>
                                  <input type="hidden" name="txtOrderDate" id="txtOrderDate" value="<?= date("Y-m-d") ?>" />
<?
                            }    
?>
...
<?
                                              ...
                                              $sReservation = getList("tbl_reservations", "id", "CONCAT(name, ' :: ', phone)", "table_id = '$iTable' AND status='R' AND date_time LIKE '".date('Y-m-d')."%'");
