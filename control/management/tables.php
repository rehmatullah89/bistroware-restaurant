...
?>
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/tables.js"></script>
</head>
...
?>
      ...
      <div id="PageTabs">
	    <ul>
	      <li><a href="<?= $_SERVER['REQUEST_URI'] ?>#tabs-1"><b>Tables</b></a></li>
<?
	if ($sUserRights["Add"] == "Y")
	{
?>
	      <li><a href="<?= $_SERVER['REQUEST_URI'] ?>#tabs-2">Add New Table</a></li>
<?
	}
...
?>
	    ...
	    <div id="tabs-1">
	      ...
	      <div id="ConfirmDelete" title="Delete Inspection?" class="hidden dlgConfirm">
	        ...
	        Are you sure, you want to Delete this Table Record?<br />
	      </div>

	      <div id="ConfirmMultiDelete" title="Delete Products?" class="hidden dlgConfirm">
	        <span class="ui-icon ui-icon-trash"></span>
	        Are you sure, you want to Delete the selected Tables Records?<br />
	      </div>
		  ...
		  <div class="dataGrid ex_highlight_row">
		    <input type="hidden" id="TotalRecords" value="<?= $iTotalRecords = getDbValue('COUNT(1)', 'tbl_tables') ?>" />
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
			  <tr valign="top">
				<td width="600">
				  ...
				  <div><input type="text" name="txtTableTitle" id="txtTableTitle" value="<?= IO::strValue("txtTableTitle") ?>" size="20" class="textbox" /></div>
												  
				  <div class="br10"></div>
                                   <label for="txtSeatsCapacity">No. Of Seats</label>
				  <div><input type="text" name="txtSeatsCapacity" id="txtSeatsCapacity" value="<?= IO::strValue("txtSeatsCapacity") ?>" size="20" class="textbox" /></div>
					  
				  <div class="br10"></div>
				 <label for="filePicture">Table Picture</label>
...
<?
		...
		{
?>
					  <option value="<?= $iFloor ?>"<?= ((IO::intValue('ddFloor') == $iFloor) ? ' selected' : '') ?>><?= $sFloor ?></option>
<?
		}
?>
				    </select>
				  ...
				  <br />
				  <button id="BtnSave">Save Table</button>
