	...
	else
	{
		...
		else
		{
			...
			if ($objDb->query($sSQL) == true && $objDb->getCount( ) == 1)
			{
				...
				$sDangerous = $objDb->getField(0, "dangerous");
				...
				$sHss        = ((@strpos(getDbValue("`type`", "tbl_school_types", "id='$iType'"), "HSS") !== FALSE) ? "Y" : "N");
				$sBlocksInfo = array( );
				$sMembers    = array( );
				...
				else
				{
					...
					$aResponse['Sor']          = (($iSors > 0) ? "Y" : "N");
					$aResponse['Disqualified'] = (($sQualified == "N") ? "Y" : "N");
					$aResponse['Dangerous']    = $sDangerous;
					$aResponse['Hss']          = $sHss;
