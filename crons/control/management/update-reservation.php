	...
	***********************************************************************************************
	...
	if ($iFloor <= 0 || $iTable <= 0 || $sName == "" || $sPhone == "" || $iGuests <= 0 || $sDateTime == "")
        ...
        if($sStatus == 'R')
        {
            ...
            $sAllEndReservations    = getList("tbl_reservations", "id", "end_time", "table_id='$iTable' AND status='R' AND date_time LIKE '".date('Y-m-d', strtotime($sDateTime))."%'", "date_time");
