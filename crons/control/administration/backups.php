...
?>
		        <tr id="<?= @basename($sFiles[$i]) ?>">
		          ...
		          <td>
					<a href="administration/download-backup.php?Type=Database&File=<?= @basename($sFiles[$i]) ?>"><img class="icnDownload" src="images/icons/download.gif" alt="Download" title="Download" /></a>
<?
...
?>
		        <tr id="<?= @basename($sFiles[$i]) ?>">
		          ...
		          <td>
					<a href="administration/download-backup.php?Type=Website&File=<?= @basename($sFiles[$i]) ?>"><img class="icnDownload" src="images/icons/download.gif" alt="Download" title="Download" /></a>
<?
			if ($sUserRights["Delete"] == "Y")
			{
?>
