<?
	...
	***********************************************************************************************
	...
	if ($_SESSION["Flag"] == "")
	{
		$sSQL = "SELECT * FROM tbl_wastage_reasons WHERE reason LIKE '$sReason' AND id!='$iReasonId'";
	...
	if ($_SESSION["Flag"] == "")
	{
		$sSQL = "UPDATE tbl_wastage_reasons SET reason = '$sReason',
                                                    status  = '$sStatus'
		         WHERE id='$iReasonId'";
...
?>
	...
	<!--
		...
		parent.showMessage("#GridMsg", "success", "The selected Wastage Reason has been Updated successfully.");
	-->
	</script>
<?
			exit( );
