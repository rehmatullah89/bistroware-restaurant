...
?>
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/suppliers.js"></script>
</head>
...
?>
      ...
      <div id="PageTabs">
	    <ul>
	      <li><a href="<?= $_SERVER['REQUEST_URI'] ?>#tabs-1"><b>Suppliers</b></a></li>
<?
	if ($sUserRights["Add"] == "Y")
	{
?>
	      <li><a href="<?= $_SERVER['REQUEST_URI'] ?>#tabs-2">Add New Supplier</a></li>
<?
	}
...
?>
	    ...
	    <div id="tabs-1">
	      ...
	      <div id="ConfirmDelete" title="Delete Inspection?" class="hidden dlgConfirm">
	        ...
	        Are you sure, you want to Delete this Supplier Record?<br />
	      </div>

	      <div id="ConfirmMultiDelete" title="Delete Products?" class="hidden dlgConfirm">
	        <span class="ui-icon ui-icon-trash"></span>
	        Are you sure, you want to Delete the selected Supplier Records?<br />
	      </div>
		  ...
		  <div class="dataGrid ex_highlight_row">
		    <input type="hidden" id="TotalRecords" value="<?= $iTotalRecords = getDbValue('COUNT(1)', 'tbl_suppliers', "status='A'") ?>" />
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
			  <tr valign="top">
				<td width="600">
				  ...
				  <div><input type="text" name="txtName" id="txtName" value="<?= IO::strValue("txtName") ?>" size="30" class="textbox" /></div>
												  
				  <div class="br10"></div>
                                  
                                  <label for="txtAddress">Address*</label>
				  <div><input type="text" name="txtAddress" id="txtAddress" value="<?= IO::strValue("txtAddress") ?>" size="30" class="textbox" /></div>
												  
				  <div class="br10"></div>

				  <label for="txtPhone">Phone</label>
				  <div><input type="text" name="txtPhone" id="txtPhone" value="<?= IO::strValue('txtPhone') ?>" size="30" class="textbox" /></div>
                                  <div class="br10"></div>
                                  
                                  <label for="txtMobile">Mobile</label>
				  <div><input type="text" name="txtMobile" id="txtMobile" value="<?= IO::strValue('txtMobile') ?>" size="30" class="textbox" /></div>
                                  <div class="br10"></div>
                                  
                                  <label for="txtFax">Fax</label>
				  <div><input type="text" name="txtFax" id="txtFax" value="<?= IO::strValue('txtFax') ?>" size="30" class="textbox" /></div>
                                  <div class="br10"></div>
                                  
                                  <label for="txtEmail">Email</label>
				  <div><input type="text" name="txtEmail" id="txtEmail" value="<?= IO::strValue('txtEmail') ?>" size="30" class="textbox" /></div>
                                  <div class="br10"></div>
                                  
                                  <label for="txtWebsite">Website</label>
				  <div><input type="text" name="txtWebsite" id="txtWebsite" value="<?= IO::strValue('txtWebsite') ?>" size="30" class="textbox" /></div>
                                  <div class="br10"></div>
                                  
                                  <label for="txtCity">City</label>
				  <div><input type="text" name="txtCity" id="txtCity" value="<?= IO::strValue('txtCity') ?>" size="30" class="textbox" /></div>
                                  <div class="br10"></div>
