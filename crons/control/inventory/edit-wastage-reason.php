<?
	...
	***********************************************************************************************
	...
	if ($_POST)
		@include("update-wastage-reason.php");


	$sSQL = "SELECT * FROM tbl_wastage_reasons WHERE id='$iReasonId'";
	$objDb->query($sSQL);
...
?>
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/edit-wastage-reason.js"></script>
</head>
