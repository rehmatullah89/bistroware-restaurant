      ...
      <div id="AccountTabs">
	    ...
	    <div id="tabs-1" class="tab">
		  <form name="frmMyAccount" id="frmMyAccount" onsubmit="return false;">
			...
			<div><input type="text" name="txtName" id="txtName" value="<?= formValue($_SESSION["AdminName"]) ?>" maxlength="50" class="textbox" <?=($_SESSION["AdminTypeId"] != 1?'readonly':'')?> /></div>
			...
			<div><input type="text" name="txtEmail" id="txtEmail" value="<?= $_SESSION["AdminEmail"] ?>" maxlength="100" class="textbox" <?=($_SESSION["AdminTypeId"] != 1?'readonly':'')?> /></div>
