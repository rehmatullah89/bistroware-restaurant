...
$(document).ready(function( )
{
	if (parseInt($("#TotalRecords").val( )) > 100)
	{
		objTable = $("#DataGrid").dataTable( { sDom            : '<"H"f<"TableTools">>t<"F"ip>',
						       ...
						       bAutoWidth      : false,
						       bServerSide     : true,
						       sAjaxSource     : "ajax/administration/get-messages.php",
		...
		if (sMessages != "")
		{
			$("#ConfirmMultiDelete").dialog( { resizable : false,
						           ...
						           buttons   : { "Delete" : function( )
									            {
											     $.post("ajax/administration/delete-message.php",
												    { Messages:sMessages },
	...
	$(document).on("click", ".icnView", function(event)
	{
		...
		$.colorbox({ href:("administration/message-details.php?MessageId=" + iMessageId), width:"800px", height:"560px", iframe:true, opacity:"0.50", overlayClose:true });
