...
$(document).ready(function( )
{
		...
		if (sReasons != "")
		{
			$("#ConfirmMultiDelete").dialog( { resizable : false,
							   ...
							   buttons   : { "Delete" : function( )
										    {
											     $.post("ajax/inventory/delete-wastage-reason.php",
												    { Reasons:sReasons },
	...
	$(document).on("click", "#DataGrid .icnEdit", function(event)
	{
		...
		$.colorbox({ href:("inventory/edit-wastage-reason.php?ReasonId=" + iReasonId + "&Index=" + iIndex), width:"400px", height:"300px", iframe:true, opacity:"0.50", overlayClose:false });
	...
	$(document).on("click", "#DataGrid .icnToggle", function(event)
	{
		...
		$.post("ajax/inventory/toggle-wastage-reason-status.php",
			{ ReasonId:objIcon.id },
	...
	$("#frmRecord #txtReason").blur(function( )
	{
		...
		$.post("ajax/inventory/check-wastage-reason.php",
